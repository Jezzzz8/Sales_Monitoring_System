    ...
    return ListTile(
      leading: Stack(
        children: [
          Icon(
            icon,
            color: isSelected ? widget.primaryColor : theme.iconTheme.color,
          ),
      ...
      title: Text(
        ...
        style: TextStyle(
          ...
          color: isSelected ? widget.primaryColor : theme.textTheme.bodyLarge?.color,
        ),
      ),
...
class _CashierSidebarState extends State<CashierSidebar> {
  ...
  Widget _buildNavItem({
    ...
    return ListTile(
      leading: Stack(
        children: [
          Icon(icon, color: isSelected ? widget.primaryColor : theme.iconTheme.color),
